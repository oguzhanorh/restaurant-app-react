import { ListItem, ListItemText,List,Paper, ListItemSecondaryAction,IconButton, ButtonGroup,makeStyles } from '@material-ui/core';
...
export default function OrderedFoodItems(props) {
  ...
  //seçili siparişi silme işlemini gerçekleştiren fonksiyon
  ...
  //siparişleri artırıp azaltacak fonksiyon
